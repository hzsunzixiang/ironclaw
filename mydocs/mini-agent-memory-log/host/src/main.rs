...
//! # Mini Agent Loop + WASM Sandbox + Session + Memory — IronClaw Core Distilled
//!
//! Builds on mini-agent-wasm-session by adding persistent long-term memory.
//! This is the workspace/memory layer that IronClaw uses to remember facts,
...
//! 4. mini-agent-memory (THIS)  → + Workspace memory (long-term memory)
//! ```
//!
...
//! |-------------------------------|------------------------------------------|
//! | No persistent memory           | File-based workspace memory              |
//! | No memory tools                | memory_search, memory_write, memory_read |
//! | No system prompt injection     | MEMORY.md loaded into system prompt      |
//! | No auto-extraction             | Auto-extract memories from turns          |
...
fn print_banner() {
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║  Mini Agent + WASM Sandbox + Session + Memory              ║");
    println!("║  IronClaw Core Distilled — Long-Term Memory Edition        ║");
    println!("╠══════════════════════════════════════════════════════════════╣");
    println!("║                                                            ║");
    println!("║  NEW: Persistent long-term memory across sessions!         ║");
    println!("║    • MEMORY.md: curated facts injected into system prompt  ║");
    println!("║    • memory_search: search past memories and context       ║");
    println!("║    • memory_write: save facts, decisions, preferences      ║");
    println!("║    • memory_read: read workspace files                     ║");
    println!("║    • Auto-extraction: memories saved from conversations    ║");
    println!("║                                                            ║");
